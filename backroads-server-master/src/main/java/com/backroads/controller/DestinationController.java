...
public class DestinationController {
    ...
    public ResponseEntity<DestinationDTO>delete(@PathVariable Long id) {
        Destination destination=service.findOne(id);
        if(destination==null){
            return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
        }
    ...
    public ResponseEntity<DestinationDTO>edit(@PathVariable Long id , @Validated @RequestBody DestinationDTO destinationDTO) {
    ...
    public ResponseEntity<DestinationDTO>save(@Validated @RequestBody DestinationDTO destinationDTO) {
        Destination destination=toDestination.convert(destinationDTO);
        if(destination==null){
            return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
        }
